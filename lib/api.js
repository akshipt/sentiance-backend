...
class API {
	...
	calculateAggregations(events) {
		...
		for (let mode in transportByMode) {
			...
			totalDuration += aggregations.transportation[mode].totalDuration;
			totalDistance += aggregations.transportation[mode].totalDistance;
			numberOfEvents += aggregations.transportation[mode].numberOfEvents;
		}
		aggregations.transportation.all = {
			totalDuration,
			totalDistance,
			numberOfEvents,
		}
